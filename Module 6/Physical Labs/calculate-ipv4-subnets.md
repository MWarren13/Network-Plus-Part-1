...
_Answer: The subnet mask tells where the network ends and the host begins. This allows you to find the network address, the valid host range, and the broadcast address. It also defines the subnet size and how many subnets and hosts exist._  
